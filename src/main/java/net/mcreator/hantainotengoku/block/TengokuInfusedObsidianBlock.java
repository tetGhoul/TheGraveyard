...
public class TengokuInfusedObsidianBlock extends HantaiNoTengokuModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(75f, 25f).lightValue(0).harvestLevel(3)
					.harvestTool(ToolType.PICKAXE).notSolid());
			setRegistryName("tengoku_infused_obsidian");
		}
