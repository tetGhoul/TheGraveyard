...
public class DemonBombItem extends HantaiNoTengokuModElements.ModElement {
	@ObjectHolder("hantai_no_tengoku:demon_bomb")
	public static final Item block = null;
	@ObjectHolder("hantai_no_tengoku:entitybulletdemon_bomb")
	public static final EntityType arrow = null;
	public DemonBombItem(HantaiNoTengokuModElements instance) {
		super(instance, 23);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletdemon_bomb").setRegistryName("entitybulletdemon_bomb"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 12.5, 8);
