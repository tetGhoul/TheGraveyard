...
import net.mcreator.hantainotengoku.procedures.DemonBombTestBulletHitsBlockProcedure;
...
public class DemonBombTestItem extends HantaiNoTengokuModElements.ModElement {
	@ObjectHolder("hantai_no_tengoku:demon_bomb_test")
	public static final Item block = null;
	@ObjectHolder("hantai_no_tengoku:entitybulletdemon_bomb_test")
	public static final EntityType arrow = null;
	public DemonBombTestItem(HantaiNoTengokuModElements instance) {
		super(instance, 26);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletdemon_bomb_test").setRegistryName("entitybulletdemon_bomb_test"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("demon_bomb_test");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 3.9999999999999996, 4);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				DemonBombTestBulletHitsBlockProcedure.executeProcedure($_dependencies);
			}
		}
