...
import net.mcreator.hantainotengoku.procedures.LightningStrikeGrimoireProcedure;
...
public class GrimoireOfTheSinsLightningItem extends HantaiNoTengokuModElements.ModElement {
	@ObjectHolder("hantai_no_tengoku:grimoire_of_the_sins_lightning")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletgrimoire_of_the_sins_lightning").setRegistryName("entitybulletgrimoire_of_the_sins_lightning"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("grimoire_of_the_sins_lightning");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				LightningStrikeGrimoireProcedure.executeProcedure($_dependencies);
			}
		}
